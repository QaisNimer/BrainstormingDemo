...
class _OrderDetailsScreenState extends State<OrderDetailsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
          ...
          children: [
            ...
            Row(
              children: [
                ...
                SizedBox(width: 8),
                Text('4.5 (89 ${AppLocalizations.of(context)!.reviews})', style: TextStyle(color: secondaryTextColor)),
              ],
            ),
            SizedBox(height: screenHeight * 0.02),
            Row(
            ...
            SizedBox(height: screenHeight * 0.02),
            Text(AppLocalizations.of(context)!.product_description, style: TextStyle(color: secondaryTextColor)),
            SizedBox(height: screenHeight * 0.03),
            Row(
                  ...
                  child: Column(
                    children: [
                      Slider(
                        ...
                        onChanged: (value) => setState(() => spiciness = value),
                      ),
                      Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
            ...
            Center(
              child: TextButton(
                onPressed: () async {
                  final double unitPrice = 7.99;
                  final int itemId = 1;

                  final CartModel newItem = CartModel(
                    itemId: itemId,
                    quantity: quantity,
                  ...
                  try {
                    bool success = await _cartService.addCartItem(newItem);
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(
                        content: Text(
                          success
                              ? AppLocalizations.of(context)!.added_to_cart_successfully
                              : AppLocalizations.of(context)!.failed_to_add_to_cart,
                        ),
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  padding: EdgeInsets.symmetric(horizontal: screenWidth * 0.25, vertical: screenHeight * 0.02),
      ...
      bottomNavigationBar: _buildBottomNavBar(screenHeight, textColor, screenWidth, context),
  ...
  Widget _quantityButton(IconData icon, VoidCallback onPressed, {bool filled = false}) {
    return Container(
      width: 30,
      height: 30,
      ...
      child: IconButton(
        icon: Icon(icon, size: 18, color: filled ? Colors.white : Colors.green),
        onPressed: onPressed,
  ...
  Widget _buildBottomNavBar(double height, Color textColor, double width, BuildContext context) {
    return BottomAppBar(
