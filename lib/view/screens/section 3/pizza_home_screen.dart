        ...
        child: Row(
          ...
          children: [
            IconButton(
              icon: Icon(
                Icons.home,
                color: selectedIndex == 0 ? Colors.green : theme.iconTheme.color,
              ),
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => HomeScreen()));
                onItemTapped(0);
            ...
            IconButton(
              icon: Icon(
                Icons.favorite,
                color: isFavoriteSelected ? Colors.green : theme.iconTheme.color,
              ),
              onPressed: () {
                setState(() {
            ...
            IconButton(
              icon: Icon(
                Icons.history,
                color: selectedIndex == 3 ? Colors.green : theme.iconTheme.color,
              ),
              onPressed: () {
            ...
            IconButton(
              icon: Icon(
                Icons.person,
                color: selectedIndex == 4 ? Colors.green : theme.iconTheme.color,
              ),
              onPressed: () {
                Navigator.push(
                  context,
