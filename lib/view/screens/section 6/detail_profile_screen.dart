          ...
          children: [
            ...
            Container(
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    _buildTextField("Username", _usernameController, (val) => profileController.updateUsername(val), isDarkMode: isDarkMode),
                    _buildTextField("Email", _emailController, (val) => profileController.updateEmail(val), isDarkMode: isDarkMode),
                    _buildTextField("Phone Number", _phoneController, (val) => profileController.updatePhoneNumber(val), isDarkMode: isDarkMode),
                    _buildTextField("Password", _passwordController, (val) => profileController.updatePassword(val), isPassword: true, isDarkMode: isDarkMode),
                    _buildTextField("Address", _addressController, (val) => profileController.updateAddress(val), isDarkMode: isDarkMode),
                  ],
                ),
              ),
            ),
